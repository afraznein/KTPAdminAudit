...
**REQUIRED: Before writing or modifying any code in this repo, invoke the `plugin-dev` skill** (`.claude/skills/plugin-dev/SKILL.md`). It carries the menu/async TOCTOU rules and deploy workflow; do not edit the .sma without it loaded.
